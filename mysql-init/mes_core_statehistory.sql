...
--
-- Dumping data for table `statehistory`
--

LOCK TABLES `statehistory` WRITE;
/*!40000 ALTER TABLE `statehistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `statehistory` ENABLE KEYS */;
UNLOCK TABLES;
